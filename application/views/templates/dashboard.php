...
<head>
    ...
    <!-- Custom fonts for this template-->
    <link href="<?= base_url(); ?>assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Plus+Jakarta+Sans:400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
...
<body style="font-family:Plus Jakarta Sans;" id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Wings</div>
            </a>
			...
			<li class="nav-item <?= $this->uri->segment(1) == 'transaction' ? 'active' : '' ?>">
            ...
            <li class="nav-item <?= $this->uri->segment(1) == 'laporan' ? 'active' : '' ?>">
                <a class="nav-link" href="<?= base_url('laporan/laporanuser/' .  $this->session->userdata('login_session')['nama']); ?>">
                    <i class="fas fa-fw fa-print"></i>
                    <span>Report</span>
                </a>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2023 &bull;</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
